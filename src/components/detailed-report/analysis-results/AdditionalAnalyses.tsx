          ...
          return (
            <Card key={index} className="p-6 bg-[#F8F9FC] border border-gray-100">
              <div className="mb-4">
                ...
                <p className="text-[#9b87f5] whitespace-pre-line leading-relaxed break-words">{analysis.function}</p>
              </div>
              <div className="grid grid-cols-2 gap-4">
                <div>
                  <p className="text-gray-700">Savings: <span className="text-[#9b87f5] font-semibold">
                ...
                <div>
                  <p className="text-gray-700">Additional Profit: <span className="text-[#9b87f5] font-semibold">
