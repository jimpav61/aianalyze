...
export const ImplementationDetails = ({ explanation, marketingStrategy }: ImplementationDetailsProps) => {
  return (
    <Card className="p-6 mt-6 bg-[#F8F9FC] border border-gray-100 print:break-inside-avoid print:page-break-inside-avoid">
      <div className="space-y-6">
        ...
        <div className="print:break-inside-avoid print:page-break-inside-avoid print:mt-4">
